...
public class RouterModel extends SysMenuEntity {
    ...
    // Objects.equals(MenuTypeEnum.DIRECTORY.getValue(), getMenuType())) {
    ...
    // children.setMeta(new MetaDTO(getMenuName(), getIcon(), !getIsCache(),
    // getPath()));
    ...
    // router.setMeta(new MetaDTO(getMenuName(), getIcon(), !getIsCache(),
    // getPath()));
    // return router;
    // }
    //
    ...
    // return isTopLevel() && MenuTypeEnum.MENU.getValue().equals(getMenuType()) &&
    // !getIsExternal();
    // }
    //
    // /**
    ...
    // return MenuTypeEnum.DIRECTORY.getValue().equals(getMenuType()) &&
    // tree.hasChild();
    // }
    //
    //
    ...
    // }
    // // 非外链并且是一级目录（类型为目录）
    // if (isTopLevel() && Objects.equals(MenuTypeEnum.DIRECTORY.getValue(),
    ...
    // return !getIsExternal() && (HttpUtil.isHttp(getPath()) ||
    // HttpUtil.isHttps(getPath()));
    // }
    //
    // /**
    // * 是否顶层目录或者菜单
