package com.biology.infrastructure.annotations.ratelimit;

import com.biology.infrastructure.annotations.ratelimit.implementation.MapRateLimitChecker;
import com.biology.infrastructure.annotations.ratelimit.implementation.RedisRateLimitChecker;
...
@Component
@Slf4j
@ConditionalOnExpression("'${biology.embedded.redis}' != 'true'")
