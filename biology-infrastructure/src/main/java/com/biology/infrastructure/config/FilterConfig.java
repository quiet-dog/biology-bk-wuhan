...
import com.biology.infrastructure.exception.GlobalExceptionFilter;
import com.biology.infrastructure.filter.TestFilter;
import com.biology.infrastructure.filter.TraceIdFilter;
...
public class FilterConfig {
    ...
    @Value("${biology.traceRequestIdKey}")
