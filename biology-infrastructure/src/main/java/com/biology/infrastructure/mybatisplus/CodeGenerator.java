package com.biology.infrastructure.mybatisplus;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        // JSON ymlJson = JSONUtil.parse(new
        // Yaml().load(ResourceUtil.getStream("application-dev.yml")));

        String databaseUrl = "jdbc:mysql://192.168.0.11:3306/biology";
        ...
        CodeGenerator generator = CodeGenerator.builder()
                ...
                .module("/biology-orm/target/generated-code")
                .parentPackage("com.biology")
                .tableName("manage_craft_archive")
                // 决定是否继承基类
    ...
    private void packageConfig(FastAutoGenerator generator) {
        generator.packageConfig(builder -> builder
                ...
                .other("other")
                // define dir related to
                // OutputFileType(entity,mapper,service,controller,mapper.xml)
    ...
    private void entityConfig(StrategyConfig.Builder builder) {
        ...
        entityBuilder
                ...
                // .superClass(BaseEntity.class)
                // .addSuperEntityColumns("creator_id", "create_time", "creator_name",
                // "updater_id", "update_time", "updater_name", "deleted")
