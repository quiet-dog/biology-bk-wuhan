...
import com.biology.common.exception.error.ErrorCode.Client;
...
import com.biology.admin.customize.service.login.UserDetailsServiceImpl;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                // X-Frame-Options 是一个 HTTP 响应头，用于防止网页被嵌入到其他网页的 <frame>、<iframe> 或 <object>
                // 标签中，从而可以减少点击劫持攻击的风险
