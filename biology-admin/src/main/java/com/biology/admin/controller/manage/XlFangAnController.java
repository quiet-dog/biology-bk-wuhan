...
public class XlFangAnController extends BaseController {
    ...
    @PutMapping("/{xlFangAnId}")
    public ResponseDTO<Void> update(@PathVariable Long xlFangAnId, @RequestBody UpdateXlFangAnCommand command) {
        command.setXlFangAnId(xlFangAnId);
