...
public class WebsocketController {
    ...
    public void sendMsg(DeviceDTO deviceDTO) {
        ...
        // redisId = "environment-" +
        // deviceDTO.getEnvironmentAlarmInfo().getEnvironmentId();
        ...
        // queryWrapper.eq("environment_id",
        // deviceDTO.getEnvironmentAlarmInfo().getEnvironmentId());
        // EnvironmentEntity environmentEntity = new
        // EnvironmentEntity().selectOne(queryWrapper);
        ...
        // detectionApplicationService.addDetection(addDetectionCommand);
        ...
        // // 添加应急调度下的报警信息
        // {
        // AddEmergencyAlarmCommand addEmergencyAlarmCommand = new
        ...
        // ThresholdEntity thresholdEntity = new
        // ThresholdEntity().selectOne(queryWrapper1);
        ...
        // queryWrapper2.eq("equipment_id",
        // deviceDTO.getEquipmentInfo().getEquipmentId());
        // EquipmentEntity equipmentEntity = new
        // EquipmentEntity().selectOne(queryWrapper2);
        ...
        // equipmentDataApplicationService.addEquipmentData(addCommand);
        // System.out.printf(
        // "添加设备档案的阈值设置=========================================================%s \n",
        ...
        // // 检查是否报警
        // ThresholdValueEntity thresholdValueEntity =
        // thresholdApplicationService.checkEquipmentInfo(
        ...
        // addEmergencyAlarmCommand.setDescription(checkEmergencyAlarmDescription(equipmentEntity,
        // thresholdEntity,
        ...
        // + deviceDTO.getEquipmentInfo().getEquipmentId());
        // List<CraftNodeEntity> craftNodeEntities =
        // craftNodeService.list(queryWrapper);
