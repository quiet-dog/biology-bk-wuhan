package com.biology.common.exception.error;
...
public enum ErrorCode implements ErrorCodeInterface {
     ...
     * 错误码的命名最好以模块为开头 比如 NOT_ALLOWED_TO_OPERATE前面加上PERMISSION =
     * PERMISSION_NOT_ALLOWED_TO_OPERATE
     */
    public enum Business implements ErrorCodeInterface {
        ...
        EQUIPMENT_CODE_EXISTS(10909, "设备编号：{} 已存在", "Business.EQUIPMENT_CODE_EXISTS"),
        EQUIPMENT_CODE_ONE_EXISTS(10909, "添加成功,存在重复的设备编号", "Business.EQUIPMENT_CODE_ONE_EXISTS"),
        ...
        PREVIEW_FILE_FAILED(10516, "预览文件失败：{}", "Business.PREVIEW_FILE_FAILED"),

        DOWNLOAD_FILE_FAILED(10517, "下载文件失败：{}", "Business.DOWNLOAD_FILE_FAILED"),
        DOWNLOAD_RECEIVE_FAILED(10517, "领用失败：{}", "Business.DOWNLOAD_FILE_FAILED"),
        ...
        Business(int code, String msg, String i18nKey) {
            ...
            Assert.isTrue(i18nKey != null && i18nKey.startsWith(errorTypeName),
                    String.format("错误码i18nKey值定义失败，%s错误码i18nKey值必须以%s开头，当前错误码为%s", errorTypeName, errorTypeName,
                            name()));
            this.code = code;
            this.msg = msg;
            this.i18nKey = i18nKey;
    ...
    public enum Internal implements ErrorCodeInterface {
        ...
        MATERIALS_CODE_EXISTS(9, "物料编码已存在", "Internal.MATERIALS_CODE_EXISTS"),
