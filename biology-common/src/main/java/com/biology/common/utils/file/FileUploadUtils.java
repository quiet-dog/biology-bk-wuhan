package com.biology.common.utils.file;
...
public class FileUploadUtils {
     ...
     */
    public static String getRelativeFileUrl(String subDir, String fileName) {
     ...
     */
    public static void isAllowedUpload(MultipartFile file, String[] allowedExtension) {
    ...
    public static String getFileAbsolutePath(String subDir, String fileName) {
        return BiologyConfig.getFileBaseDir() + File.separator + subDir + File.separator + fileName;
    }
