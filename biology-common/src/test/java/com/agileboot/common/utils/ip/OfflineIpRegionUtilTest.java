...
class OfflineIpRegionUtilTest {
    ...
    void testGetIpRegionWithIpv6() {
        IpRegion region = Assertions
                .assertDoesNotThrow(() -> OfflineIpRegionUtil.getIpRegion("2001:0DB8:0000:0023:0008:0800:200C:417A"));
    ...
    void testGetIpRegionWithEmpty() {
        IpRegion region = Assertions.assertDoesNotThrow(() -> OfflineIpRegionUtil.getIpRegion(""));
    ...
    void testGetIpRegionWithNull() {
        IpRegion region = Assertions.assertDoesNotThrow(() -> OfflineIpRegionUtil.getIpRegion(null));
    ...
    void testGetIpRegionWithWrongIpString() {
        IpRegion region = Assertions.assertDoesNotThrow(() -> OfflineIpRegionUtil.getIpRegion("asfdsfdsff"));
        Assertions.assertNull(region);
    }
}
